...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        Widget->resize(669, 557);
        layoutWidget = new QWidget(Widget);
        layoutWidget->setObjectName("layoutWidget");
        layoutWidget->setGeometry(QRect(30, 20, 631, 521));
        gridLayout = new QGridLayout(layoutWidget);
        gridLayout->setObjectName("gridLayout");
        gridLayout->setContentsMargins(0, 0, 0, 0);
        webcon_tytle = new QLabel(layoutWidget);
        ...
        serial_comboBox = new QComboBox(layoutWidget);
        ...
        baudrate_label = new QLabel(layoutWidget);
        ...
        baundrate_comboBox = new QComboBox(layoutWidget);
        ...
        layoutWidget1->setGeometry(QRect(90, 40, 181, 52));
        temp_layout = new QHBoxLayout(layoutWidget1);
        ...
        lineEdit_T = new QLineEdit(layoutWidget1);
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        label_5->setText(QCoreApplication::translate("Widget", " \346\260\224\345\216\213:", nullptr));
